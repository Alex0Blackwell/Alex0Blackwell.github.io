...
! function(t, e) {
    "use strict";
    "function" == typeof define && false && define.amd ? define(e) : "object" == typeof exports ? module.exports = e() : t.embedLightBox = e()
}(this, function() {
    "use strict";
    ...
    function e(t, e) {
        ...
        U[t] = o, [].forEach.call(n, function(t) {
            e && e.filterlightem && (V = e.filterlightem);
            var n = [];
            if (n = "A" === t.tagName ? [t] : t.getElementsByTagName("a"), n = [].filterlightem.call(n, function(t) {
    ...
    function i() {
        return (S = T("embed-lightbox-overlay")) ? (P = T("embed-lightbox-slider"), F = T("previous-button"), H = T("next-button"), void(L = T("close-button"))) : (S = N("div"), S.setAttribute("role", "dialog"), S.id = "embed-lightbox-overlay", document.getElementsByTagName("body")[0].appendChild(S), P = N("div"), P.id = "embed-lightbox-slider", S.appendChild(P), F = N("button"), F.setAttribute("type", "button"), F.id = "previous-button", F.setAttribute("aria-label", "Previous"), F.innerHTML = M.svg ? I : "&lt;", S.appendChild(F), H = N("button"), H.setAttribute("type", "button"), H.id = "next-button", H.setAttribute("aria-label", "Next"), H.innerHTML = M.svg ? Y : "&gt;", S.appendChild(H), L = N("button"), L.setAttribute("type", "button"), L.id = "close-button", L.setAttribute("aria-label", "Close"), L.innerHTML = M.svg ? q : "&times;", S.appendChild(L), F.className = H.className = L.className = "embed-lightbox-button", void r())
    }
    ...
    function u(t, e) {
        if (R !== t) {
            ...
            W.length = 0;
            for (var n, o = [], i = [], a = 0; a < t.length; a++) n = N("div"), n.className = "full-image", n.id = "embed-lightbox-img-" + a, W.push(n), o.push("embed-lightbox-figure-" + a), i.push("embed-lightbox-figcaption-" + a), P.appendChild(W[a]);
    ...
    function s(t) {
        ...
        P.style.transition = P.style.webkitTransition = "fadeIn" === j.animation ? "opacity .1s ease" : "slideIn" === j.animation ? "" : "none", "auto" === j.buttons && ("ontouchstart" in window || 1 === R.length) && (j.buttons = !1), F.style.display = H.style.display = j.buttons ? "" : "none";
        try {
    ...
    function m(t, e) {
        ...
        if ("undefined" != typeof n) {
            ...
            var o = R[t].imageElement,
                ...
                r = b(o),
                l = N("figure");
            if (l.id = "embed-lightbox-figure-" + t, l.innerHTML = '<div class="embed-lightbox-spinner"><div class="embed-lightbox-double-bounce1"></div><div class="embed-lightbox-double-bounce2"></div></div>', j.captions && a) {
                var u = N("figcaption");
                u.id = "embed-lightbox-figcaption-" + t, u.innerHTML = a, l.appendChild(u)
            }
            n.appendChild(l);
            var s = N("img");
            s.onload = function() {
                var n = document.querySelector("#embed-lightbox-img-" + t + " .embed-lightbox-spinner");
    ...
    function y() {
        ...
        }, 100)) : M.transforms ? P.style.transform = P.style.webkitTransform = "translate3d(" + t + ",0,0)" : P.style.left = t
    }
    ...
    function A() {
        l(), n(), B(document, "keydown", a), document.getElementsByTagName("body")[0].removeChild(document.getElementById("embed-lightbox-overlay")), U = {}, R = [], z = 0
    }
    var S, P, F, H, L, I = '<svg width="44" height="60"><polyline points="30 10 10 30 30 50" stroke="rgba(255,255,255,0.5)" stroke-width="4"stroke-linecap="butt" fill="none" stroke-linejoin="round"/></svg>',
        ...
        G = null,
        J = function(t) {
            t.target.id.indexOf("embed-lightbox-img") !== -1 && p()
        },
        K = function(t) {
    ...
    }), [].filterlightem || (Array.prototype.filterlightem = function(t, e, n, o, i) {
