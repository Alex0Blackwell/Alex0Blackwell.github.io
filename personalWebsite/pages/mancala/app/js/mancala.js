...
function init()
{
    ...
    document.getElementsByClassName("one-player")[0].innerHTML = getMessage("One Player");
    document.getElementsByClassName("two-player")[0].innerHTML = getMessage("Two Player");
    document.getElementsByClassName("marble-count")[0].innerHTML = getMessage("Enter Marble Count Below");
    document.getElementsByClassName("sound")[0].innerHTML = getMessage("Sound Effects");
    document.getElementById("on").innerHTML= getMessage("On");
    document.getElementById("off").innerHTML= getMessage("Off");
    document.getElementsByClassName("start-button")[0].innerHTML= getMessage("Start");
...
function initGame()
{
    if(!gameinit)
    {
        document.getElementsByClassName("settings-title")[0].innerHTML = getMessage("Settings");
        // document.getElementsByClassName("settings-return_text")[0].innerHTML = getMessage("return_to_game");
        document.getElementsByClassName("settings-sound")[0].innerHTML = getMessage("Sound Effects");
        document.getElementById("sound-on").innerHTML = getMessage("On");
        document.getElementById("sound-off").innerHTML = getMessage("Off");
        document.getElementsByClassName("commentary")[0].innerHTML = getMessage("Hidden Message");
        document.getElementById("commentary_on").innerHTML = getMessage("Off");
        document.getElementById("commentary_off").innerHTML = getMessage("Show");
        document.getElementsByClassName("help-title")[0].innerHTML = getMessage("If You're Not a Mancala God");
        // document.getElementsByClassName("help-return_text")[0].innerHTML = getMessage("return_to_game");
        document.getElementsByClassName("option-buttons no")[0].innerHTML = getMessage("No");
        document.getElementsByClassName("option-buttons yes")[0].innerHTML = getMessage("Yes");
        document.getElementsByClassName("restart-buttons no")[0].innerHTML = getMessage("No");
        document.getElementsByClassName("restart-buttons yes")[0].innerHTML = getMessage("Yes");
        document.getElementById("player1-score_text").innerHTML = getMessage("player 1: ")+" 0";
        document.getElementsByClassName("endgame-start-new")[0].innerHTML = getMessage("New Game?");
        document.getElementsByClassName("restart-start-new")[0].innerHTML = getMessage("New Game?");
...
function drawText(pit, beadnumber)
{
    ...
    case 5:
        ...
        break;
    case 6:
        document.getElementById("player1-score_text").innerHTML = getMessage("player 1: ")+" "+beadnumber;
        break;
    case 12:
    ...
    case 7:
        ...
        break;
    case 13:
        document.getElementById("player2-score_text").innerHTML = getMessage("player 2: ")+" "+beadnumber;
        break;
    }
}
...
function clearBoard()
{
    ...
    for(var holes = 0; holes < 14; holes++)
    {
        ...
        {
            document.getElementById("player2-score_text").innerHTML = getMessage("player 2: ")+" 0";
        }
        else
        {
...
function changeTurns()
{
    ...
    if(winner == 0 || winner == 1)
    {
        ...
        document.getElementById("endgame-wintext").innerHTML = (winner==0 ? getMessage("Player 1 Victory Royale!") : getMessage("Player 2 Victory Royale!"));
